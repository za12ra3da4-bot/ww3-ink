...
import { cleanLook, LOOKS, TEAMS, defaultSkin } from '../shared/config.js';
...
// ── 총 ───────────────────────────────────────────
// [도형, 재질(b 몸체 무늬 · a 강조 · m 금속 · g 렌즈), 위치, 회전]
const GUNS = {
  rifle: [
    [() => rbox(0.07, 0.11, 0.42, 0.012), 'b', [0, 0, 0]],
    [() => box(0.045, 0.02, 0.34), 'm', [0, 0.066, -0.03]],
    [() => rbox(0.078, 0.092, 0.27, 0.015), 'b', [0, -0.004, -0.335]],
    [() => box(0.082, 0.014, 0.18), 'a', [0, 0.036, -0.335]],
    [() => cylZ(0.012, 0.012, 0.3), 'm', [0, 0.016, -0.6]],
    [() => cylZ(0.02, 0.018, 0.07), 'm', [0, 0.016, -0.77]],
    [() => box(0.012, 0.06, 0.014), 'm', [0, 0.06, -0.43]],
    [() => rbox(0.05, 0.05, 0.08, 0.01), 'm', [0, 0.1, -0.03]],
    [() => cylZ(0.017, 0.017, 0.012, 14), 'g', [0, 0.1, -0.072]],
    [() => box(0.045, 0.14, 0.07), 'm', [0, -0.12, -0.1], [0.22, 0, 0]],
    [() => box(0.043, 0.1, 0.066), 'm', [0, -0.222, -0.14], [0.42, 0, 0]],
    [() => rbox(0.042, 0.11, 0.052, 0.01), 'm', [0, -0.1, 0.09], [-0.32, 0, 0]],
    [() => rbox(0.056, 0.1, 0.2, 0.014), 'b', [0, -0.02, 0.31]],
    [() => box(0.062, 0.13, 0.03), 'm', [0, -0.03, 0.425]],
  ],
  smg: [
    [() => rbox(0.062, 0.1, 0.3, 0.012), 'b', [0, 0, 0]],
    [() => box(0.068, 0.036, 0.12), 'a', [0, 0.012, -0.02]],
    [() => cylZ(0.026, 0.026, 0.15, 12), 'm', [0, 0.012, -0.215]],
    [() => cylZ(0.011, 0.011, 0.08, 8), 'm', [0, 0.012, -0.32]],
    [() => box(0.036, 0.18, 0.052), 'm', [0, -0.135, -0.08], [0.12, 0, 0]],
    [() => rbox(0.04, 0.1, 0.05, 0.01), 'm', [0, -0.095, 0.08], [-0.3, 0, 0]],
    [() => cylY(0.018, 0.02, 0.1, 10), 'b', [0, -0.085, -0.19]],
    [() => box(0.012, 0.012, 0.22), 'm', [0.022, 0.02, 0.24]],
    [() => box(0.012, 0.012, 0.22), 'm', [-0.022, 0.02, 0.24]],
    [() => box(0.056, 0.1, 0.022), 'm', [0, -0.005, 0.35]],
    [() => box(0.01, 0.035, 0.01), 'm', [0, 0.065, -0.1]],
  ],
  sniper: [
    [() => rbox(0.07, 0.1, 0.62, 0.014), 'b', [0, -0.012, 0.03]],
    [() => rbox(0.058, 0.06, 0.2, 0.012), 'b', [0, 0.05, 0.26]],
    [() => box(0.064, 0.14, 0.035), 'm', [0, -0.035, 0.35]],
    [() => box(0.074, 0.014, 0.3), 'a', [0, 0.035, -0.1]],
    [() => cylZ(0.015, 0.013, 0.62), 'm', [0, 0.022, -0.55]],
    [() => cylZ(0.024, 0.022, 0.09), 'm', [0, 0.022, -0.89]],
    [() => cylZ(0.025, 0.025, 0.32, 14), 'm', [0, 0.105, -0.03]],
    [() => cylZ(0.036, 0.026, 0.1, 14), 'm', [0, 0.105, -0.23]],
    [() => cylZ(0.03, 0.025, 0.07, 14), 'm', [0, 0.105, 0.15]],
    [() => cylZ(0.031, 0.031, 0.006, 16), 'g', [0, 0.105, -0.281]],
    [() => cylY(0.02, 0.02, 0.04), 'm', [0, 0.125, -0.03]],
    [() => box(0.02, 0.05, 0.02), 'm', [0, 0.065, -0.12]],
    [() => box(0.02, 0.05, 0.02), 'm', [0, 0.065, 0.08]],
    [() => cylX(0.008, 0.008, 0.07, 6), 'm', [0.045, 0.035, 0.06]],
    [() => sphere(0.014), 'm', [0.08, 0.035, 0.06]],
    [() => box(0.048, 0.06, 0.09), 'm', [0, -0.085, -0.06]],
    [() => rbox(0.04, 0.1, 0.05, 0.01), 'm', [0, -0.1, 0.13], [-0.35, 0, 0]],
    [() => box(0.01, 0.2, 0.01), 'm', [0.02, -0.08, -0.52], [0.35, 0, 0.25]],
    [() => box(0.01, 0.2, 0.01), 'm', [-0.02, -0.08, -0.52], [0.35, 0, -0.25]],
  ],
  shotgun: [
    [() => rbox(0.066, 0.1, 0.28, 0.014), 'b', [0, 0, 0]],
    [() => cylZ(0.017, 0.017, 0.58, 12), 'm', [0, 0.03, -0.43]],
    [() => cylZ(0.015, 0.015, 0.46), 'm', [0, -0.012, -0.37]],
    [() => rbox(0.064, 0.062, 0.19, 0.018), 'b', [0, -0.014, -0.31]],
    [() => cylZ(0.034, 0.034, 0.012, 12), 'a', [0, -0.014, -0.26]],
    [() => cylZ(0.034, 0.034, 0.012, 12), 'a', [0, -0.014, -0.36]],
    [() => rbox(0.056, 0.11, 0.3, 0.016), 'b', [0, -0.045, 0.27], [0.12, 0, 0]],
    [() => rbox(0.04, 0.09, 0.05, 0.01), 'm', [0, -0.085, 0.1], [-0.35, 0, 0]],
    [() => sphere(0.007), 'a', [0, 0.05, -0.71]],
    [() => cylY(0.01, 0.01, 0.05, 8), 'a', [0.037, 0.005, -0.03]],
    [() => cylY(0.01, 0.01, 0.05, 8), 'a', [0.037, 0.005, 0.0]],
    [() => cylY(0.01, 0.01, 0.05, 8), 'a', [0.037, 0.005, 0.03]],
  ],
  pistol: [
    [() => rbox(0.036, 0.042, 0.21, 0.008), 'b', [0, 0.03, -0.035]],
    [() => box(0.03, 0.028, 0.18), 'm', [0, 0, -0.03]],
    [() => rbox(0.034, 0.12, 0.052, 0.01), 'a', [0, -0.07, 0.045], [-0.22, 0, 0]],
    [() => cylZ(0.008, 0.008, 0.02, 8), 'm', [0, 0.03, -0.145]],
    [() => box(0.008, 0.012, 0.008), 'm', [0, 0.056, -0.13]],
    [() => box(0.022, 0.012, 0.01), 'm', [0, 0.056, 0.06]],
    [() => box(0.006, 0.03, 0.05), 'm', [0, -0.025, -0.02]],
  ],
  rocket: [
    [() => cylZ(0.042, 0.042, 0.95, 16), 'b', [0, 0.02, 0]],
    [() => rbox(0.1, 0.1, 0.26, 0.02), 'a', [0, 0.02, -0.02]],
    [() => cylZ(0.05, 0.05, 0.12, 12), 'm', [0, 0.02, -0.52]],
    [() => coneZ(0.075, 0.3, 14), 'm', [0, 0.02, -0.72]],
    [() => coneZ(0.07, 0.16, 14, true), 'm', [0, 0.02, 0.54]],
    [() => rbox(0.036, 0.1, 0.045, 0.01), 'm', [0, -0.07, 0.05], [-0.2, 0, 0]],
    [() => rbox(0.036, 0.09, 0.045, 0.01), 'm', [0, -0.07, -0.2], [0.1, 0, 0]],
    [() => box(0.03, 0.06, 0.05), 'm', [0, 0.09, -0.1]],
    [() => sphere(0.022), 'a', [0, 0.02, -0.87]],
  ],
};
export const GUN_MUZZLE = { rifle: -0.8, smg: -0.36, sniper: -0.94, shotgun: -0.72, pistol: -0.155, rocket: -0.87 };
// [손잡이, 받침손] (총 좌표)
export const GRIPS = {
  rifle: [[0, -0.1, 0.09], [0, -0.04, -0.34]],
  smg: [[0, -0.09, 0.08], [0, -0.12, -0.19]],
  sniper: [[0, -0.09, 0.13], [0, -0.05, -0.3]],
  shotgun: [[0, -0.085, 0.1], [0, -0.03, -0.31]],
  pistol: [[0, -0.06, 0.045], [-0.02, -0.075, 0.03]],
  rocket: [[0, -0.08, 0.05], [0, -0.07, -0.2]],
};
...
export function buildGun(id, skinId) {
  ...
  const mats = { b: M.body, a: M.accent, m: M.metal, g: glass };
